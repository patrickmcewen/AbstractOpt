...
from step_py.datatype import DynTile, ElementTP, Tile, MultiHot, Index, Buffer
...
@dataclass
class DynEmpty(InitFn):
    """
    A function that initializes a Tile with zeros.
    One dim is a dynamic dimension.
    """

    def apply(self) -> DynTile:
        return DynTile(shape=self.shape, tile_dtype=self.dtype)
