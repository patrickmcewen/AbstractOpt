...
async def curate_experiences(
    ...
    selected_names = parse_curator_response(result.final_output, available)

    return [best_per_kernel[name] for name in selected_names if name in best_per_kernel]
