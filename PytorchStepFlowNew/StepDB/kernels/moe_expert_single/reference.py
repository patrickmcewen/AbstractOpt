"""PyTorch reference: Single MoE expert with gated MLP.

Full MoE layer for a single batch of tokens routed to one expert:
  output = down(silu(gate(x)) * up(x))

This isolates the expert computation from the routing/partitioning logic,
which is the core building block that OpenEvolve needs to optimize.
"""
import torch
